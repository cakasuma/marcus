    ...
    public partial class AdminAddCourse : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["addcourse"] != null)
            {
                ...
                string youtid = Request.Form["youtubeid"];
                ...
                string query = "INSERT INTO Videos (videoName, videoCategory, videoRewards, videoDescription, youtubeId) VALUES ('" + name + "','" + category + "', " + amount + ", '" + desc + "', '" + youtid + "')";
